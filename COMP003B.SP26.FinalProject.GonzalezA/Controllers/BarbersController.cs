...
namespace COMP003B.SP26.FinalProject.GonzalezA.Controllers
{
    public class BarbersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("BarberId,Name,PhoneNumber,Specialty,YearsExperience")] Barber barber)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BarberId,Name,PhoneNumber,Specialty,YearsExperience")] Barber barber)
        {
